...
try{
 ...
 await p.locator('#ghClose').click();await p.locator('#blankBtn').click();await open();await p.locator('#ghLoad').click();await p.waitForFunction(()=>document.getElementById('ghStatus').textContent.includes('불러왔습니다'));
