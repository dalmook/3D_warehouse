...
// Keep the existing editor and its saved layouts intact; v9 is an optional entry.
function addWarehouseCityEntry() {
  if (document.getElementById("warehouse-city-entry")) return;
  const link = document.createElement("a");
  link.id = "warehouse-city-entry";
  link.href = "./city.html";
  link.textContent = "새 창고 설계 · 운영 · 내부 체험 ↗ (v9 미리보기)";
  link.setAttribute("aria-label", "Warehouse City v9 미리보기 열기");
